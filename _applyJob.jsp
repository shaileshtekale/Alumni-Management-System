...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item linkSize active" aria-current="page"> <i class="fa fa-arrow-right" aria-hidden="true"></i> Apply For Job</li>
  </ol>
</nav>
</div>
<hr>
<div class="container"> 
	<sf:form method="post"
		action="${pageContext.request.contextPath}/ctl/applyJob"
		modelAttribute="form" enctype="multipart/form-data">
		<div class="card">
			<h5 class="card-header bgcolor"
				style="color: white;">Apply For Job</h5>
			<div class="card-body">
				...
				<div class="col-md-6">
					<s:bind path="file">
						...
						<sf:input type="file" path="${status.expression}"
							placeholder="Enter File" class="form-control" required="required" />
						<font color="red" style="font-size: 13px"><sf:errors
								path="${status.expression}" /></font>
					</s:bind>
				</div>
